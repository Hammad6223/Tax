  ...
  <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Qubitars.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by Qubitars
                            </div>
                        </div>
                    </div>
                </div>
 ...
 <!-- Theme Settings -->
  <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
    ...
    <!-- Dashboard init -->
    <script src="{{asset('public/assets/js/pages/dashboard-analytics.init.js')}}"></script>
  ...
  <!-- rater-js plugin -->
  <script src="{{asset('public/assets/libs/rater-js/index.js')}}"></script>
   <!-- rating init -->
   <script src="{{asset('public/assets/js/pages/rating.init.js')}}"></script>

  <!-- glightbox js -->
  <script src="{{asset('public/assets/libs/glightbox/js/glightbox.min.js')}}"></script>

   <!-- isotope-layout -->
   <script src="{{asset('public/assets/libs/isotope-layout/isotope.pkgd.min.js')}}"></script>
